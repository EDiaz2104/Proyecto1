...
public class UbicacionRestActivity extends AppCompatActivity {
    EditText etIdBuscar, etId, etNombre;
        ...
        btnAgregar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etNombre.getText().toString().equals("")) {
                    ...
                    agregarUbicacion(api, etId.getText().toString(), etNombre.getText().toString());
                }
            }
        });
        ...
        btnEditar.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                if (etId.getText().toString().equals("") || etNombre.getText().toString().equals("")) {
                    ...
                    editarUbicacion(api, etId.getText().toString(), etNombre.getText().toString());
                }
            }
        });
    }

    public void getUbicacion(final UbicacionInterface api, String idUbicacion) {
        listaUbicacion.clear();
        Call<Ubicacion> call = api.obtenerUbicacion(idUbicacion);
    ...
    public void getUbicaciones(UbicacionInterface api) {
        ...
        call.enqueue(new Callback<List<Ubicacion>>() {
            ...
            public void onResponse(Call<List<Ubicacion>> call, Response<List<Ubicacion>> response) {
                listaUbicacion = new ArrayList<>(response.body());
    ...
    public void eliminarUbicacion(final UbicacionInterface api, String idUbicacion) {
        listaUbicacion.clear();

        Call<Void> call = api.eliminarUbicacion(idUbicacion);
    ...
    public void agregarUbicacion(final UbicacionInterface api, String id, String descripcion) {
        listaUbicacion.clear();
    ...
    public void editarUbicacion(final UbicacionInterface api, String id, String descripcion) {
        ...
        Call<Void> call = api.editarUbicacion(ubicacion, id);
        call.enqueue(new Callback<Void>() {
            @Override
            public void onResponse(Call<Void> call, Response<Void> response) {
                switch (response.code()) {
