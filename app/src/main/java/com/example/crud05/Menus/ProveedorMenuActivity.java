...
public class ProveedorMenuActivity extends ListActivity {
    String[] menu={"Insertar Registro","Actualizar Registro","Consultar Registro", "Eliminar Registro"};
    String[] activities={"Proveedor.ProveedorCreateActivity","Proveedor.ProveedorUpdateActivity","Proveedor.ProveedorReadActivity", "Proveedor.ProveedorDeleteActivity"};
